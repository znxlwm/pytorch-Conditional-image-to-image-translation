...
parser.add_argument('--A_data', default='A',  help='domain A dataset name')
parser.add_argument('--B_data', default='B',  help='domain B dataset name')
...
train_loader_A = utils.data_load(os.path.join('data', args.dataset), args.A_data, transform, args.batch_size, shuffle=True, drop_last=True)
train_loader_B = utils.data_load(os.path.join('data', args.dataset), args.B_data, transform, args.batch_size, shuffle=True, drop_last=True)
test_loader_A = utils.data_load(os.path.join('data', args.dataset), args.A_data + '_test', transform, 1, shuffle=True, drop_last=True)
test_loader_B = utils.data_load(os.path.join('data', args.dataset), args.B_data + '_test', transform, 1, shuffle=True, drop_last=True)
